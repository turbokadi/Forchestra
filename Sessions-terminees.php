...
<head>
    <meta charset="UTF-8">
    <title>Forchestra - Sessions terminées</title>
        ...
        <img src="images/Logo-Forchestra.png" class="resize1">
			<nav>
		        <ul>
		            ...
		            <li class="alinea" style="font-weight: bold;"><a href="Sessions-terminees.php">Sessions terminées</a></li>
			...
			<!--Les sessions-->
		 	<ul class="w3-ul w3-card-4">
			    <li class="w3-bar">
			      ...
			      <img src="images/dossier_cloturé.png" class="w3-bar-item w3-hide-small" style="width:85px">
